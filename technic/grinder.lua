...
register_grinder_recipe("default:steel_ingot","technic:iron_dust 2") 
...
register_grinder_recipe("default:copper_ingot","technic:copper_dust 2")
register_grinder_recipe("default:gold_lump","technic:gold_dust 2") 
register_grinder_recipe("default:gold_ingot","technic:gold_dust 2") 
--register_grinder_recipe("default:bronze_ingot","technic:bronze_dust 2")  -- Dust does not exist yet
--register_grinder_recipe("home_decor:brass_ingot","technic:brass_dust 2") -- needs check for the mod
register_grinder_recipe("moreores:tin_lump","technic:tin_dust 2") 
register_grinder_recipe("moreores:tin_ingot","technic:tin_dust 2") 
register_grinder_recipe("moreores:silver_lump","technic:silver_dust 2")
register_grinder_recipe("moreores:silver_ingot","technic:silver_dust 2")
register_grinder_recipe("moreores:mithril_lump","technic:mithril_dust 2") 
register_grinder_recipe("moreores:mithril_ingot","technic:mithril_dust 2") 
register_grinder_recipe("technic:chromium_lump","technic:chromium_dust 2") 
register_grinder_recipe("technic:chromium_ingot","technic:chromium_dust 2") 
register_grinder_recipe("technic:stainless_steel_ingot","stainless_steel_dust 2") 
register_grinder_recipe("technic:brass_ingot","technic:brass_dust 2") 
register_grinder_recipe("technic:zinc_lump","technic:zinc_dust 2") 
register_grinder_recipe("technic:zinc_ingot","technic:zinc_dust 2") 
