...
minetest.register_alias("generator_mv", "technic:generator_active_mv")
...
minetest.register_node("technic:generator_active_mv", {
...
minetest.register_abm({
	nodenames = {"technic:generator_mv","technic:generator_active_mv"},
	interval = 1,
	chance = 1,
	...
	if burn_time==0 then
		...
		burn_time=8
		meta:set_float("burn_time",burn_time)
		hacky_swap_node (pos,"technic:generator_active_mv") 
		end
		end
	end
...
register_MV_machine ("technic:generator_mv","PR")
register_MV_machine ("technic:generator_active_mv","PR")
