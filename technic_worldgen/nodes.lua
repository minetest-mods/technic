...
minetest.register_node( ":technic:mineral_uranium", {
	...
	groups = {cracky=3, radioactive=1, rad_resistant=71},
...
minetest.register_node( ":technic:mineral_chromium", {
	...
	is_ground_content = true,
	groups = {cracky=3, rad_resistant=19},
	sounds = default.node_sound_stone_defaults(),
...
minetest.register_node( ":technic:granite", {
	...
	is_ground_content = true,
	groups = {cracky=1, rad_resistant=18},
	sounds = default.node_sound_stone_defaults(),
})
...
minetest.register_node( ":technic:marble", {
	...
	is_ground_content = true,
	groups = {cracky=3, marble=1, rad_resistant=18},
	sounds = default.node_sound_stone_defaults(),
})
...
minetest.register_node( ":technic:marble_bricks", {
	...
	is_ground_content = false,
	groups = {cracky=3, rad_resistant=18},
	sounds = default.node_sound_stone_defaults(),
})
...
minetest.register_node(":technic:chromium_block", {
	...
	is_ground_content = true,
	groups = {cracky=1, level=2, rad_resistant=37},
	sounds = default.node_sound_stone_defaults()
})
...
minetest.register_node(":technic:zinc_block", {
	...
	is_ground_content = true,
	groups = {cracky=1, level=2, rad_resistant=36},
	sounds = default.node_sound_stone_defaults()
})
...
minetest.register_node(":technic:lead_block", {
	...
	is_ground_content = true,
	groups = {cracky=1, level=2, rad_resistant=80},
	sounds = default.node_sound_stone_defaults()
})
...
minetest.register_node(":technic:cast_iron_block", {
	...
	is_ground_content = true,
	groups = {cracky=1, level=2, rad_resistant=40},
	sounds = default.node_sound_stone_defaults()
})
